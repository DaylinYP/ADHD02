...
<body style="background-color:#124f4f">
    <div class="container">
        ...
        <form action="<?= base_url('modificar_clientes'); ?>" method="post">
            <div class="mb-3">
                ...
                <input type="text" name="txtClienteId" id="txtClienteId" class="form-control" placeholder="Ingrese ID"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="txtCorreoElectronico" id="txtCorreoElectronico" class="form-control"
                    placeholder="Ingrese correo electrónico" value="<?= $datos['correo_electronico']; ?>">
            </div>

            <div class="mb-3">
                <label for="txtCalleAvenida" class="form-label">Calle / Avenida</label>
                <input type="text" name="txtCalleAvenida" id="txtCalleAvenida" class="form-control"
                    placeholder="Ingrese Calle o Avenida" value="<?= $datos['calle_avenida']; ?>">
            </div>

            <div class="mb-3">
                <label for="txtNoCasa" class="form-label">No. Casa</label>
                <input type="text" name="txtNoCasa" id="txtNoCasa" class="form-control"
                    placeholder="Ingrese número de casa" value="<?= $datos['no_casa']; ?>">
            </div>
            <div class="mb-3">
                <label for="txtZona" class="form-label">Cliente ID</label>
                <input type="text" name="txtZona" id="txtZona" class="form-control"
                    placeholder="Ingrese zona" value="<?= $datos['zona']; ?>">
            </div>
