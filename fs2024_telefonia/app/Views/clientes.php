...
<body style="background-color: #6e6e6e;">
    ...
    <div class="container">
        <br>
        <a class="btn btn-outline-warning shadow-lg p-3 mb-5 bg-body rounded" href="nuevo_cliente" role="button">Regresar<< </a>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('eliminar_clientes/') . $clientes['cliente_id']; ?>" class="btn btn-danger"><i class="bi bi-trash-fill"> Eliminar</i></a>
                                </td>
                            </tr>
                        <?php
                        endforeach;
